...
public class RobotTest {
    ...
    // 群号码
    private static long GROUP_ID_HUORENQUN = 123;

    public static void main(String[] args) throws InterruptedException {

        // 使用自定义的配置
        final Bot bot = BotFactoryJvm.newBot(12345, "12345", new BotConfiguration() {
            {
                //保存设备信息到文件
        ...
        Events.registerEvents(bot, new SimpleListenerHost() {
            ...
            public ListeningStatus onGroupMessage(GroupMessageEvent event) {
                ...
                // 活人群机器人
                if(event.getGroup().getId() == GROUP_ID_HUORENQUN){
                    String msgString = RobotTest.toString(event.getMessage());
